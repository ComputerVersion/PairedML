...
class ProcessConnection(QWidget, Ui_Process):
    def __init__(self, parent=None):
        ...
        # 在此位置添加: Pair功能
        self.DatePairGenTrain.clicked.connect(self.LoadTrainingDataPair)
        self.DatePairGenTest.clicked.connect(self.LoadTestingDataPair)
        ...
        # for pair function
        self.radio5FolderPair.clicked.connect(self.UpdatePipelineText)
        self.radio10FolderPair.clicked.connect(self.UpdatePipelineText)
        self.radioLeaveOOPair.clicked.connect(self.UpdatePipelineText)
    ...
    def LoadTrainingDataPair(self):
        ...
        with open(original_file_name, 'r', encoding="utf-8") as csvfile:
            ...
            results.to_csv(file_name, encoding='utf_8')
    ...
    def MakePipelines(self):
        ...
        # for pair function
        elif self.radio5FolderPair.isChecked:
            cv = CrossValidation5FolderPair()
        elif self.radio10FolderPair.isChecked:
            cv = CrossValidation10FolderPair()
        elif self.radioLeaveOOPair.isChecked:
    ...
    def UpdatePipelineText(self):
        ...
        # for pair function
            ...
            cv_method += "5-FolderPair\n"
        elif self.radio10FolderPair.isChecked:
            cv_method += "10-FolderPair\n"
        elif self.radioLeaveOOPair.isChecked:
            cv_method += "Leave-One-OutPair\n"
