...
# Form implementation generated from reading ui file 'D:\FAE027\FAE-master\GUI\Process.ui'
#
...
class Ui_Process(object):
    def setupUi(self, Process):
        ...
        self.DatePairGenTrain = QtWidgets.QPushButton(self.groupBox)
        self.DatePairGenTrain.setObjectName("DatePairGenTrain")
        self.horizontalLayout_2.addWidget(self.DatePairGenTrain)
        ...
        self.DatePairGenTest = QtWidgets.QPushButton(self.groupBox)
        self.DatePairGenTest.setObjectName("DatePairGenTest")
        self.horizontalLayout_3.addWidget(self.DatePairGenTest)
        ...
        self.radio5FolderPair = QtWidgets.QRadioButton(self.groupBox_2)
        self.radio5FolderPair.setObjectName("radio5FolderPair")


        self.horizontalLayout.addWidget(self.radio5FolderPair)
        self.radio10FolderPair = QtWidgets.QRadioButton(self.groupBox_2)
        self.radio10FolderPair.setObjectName("radio10FolderPair")
        self.horizontalLayout.addWidget(self.radio10FolderPair)
        self.radioLeaveOOPair = QtWidgets.QRadioButton(self.groupBox_2)
        self.radioLeaveOOPair.setObjectName("radioLeaveOOPair")
        self.horizontalLayout.addWidget(self.radioLeaveOOPair)
        ...
        self.buttonRun.setMinimumSize(QtCore.QSize(0, 35))
    ...
    def retranslateUi(self, Process):
        ...
        self.label.setText(_translate("Process", "Trainingdata"))
        self.buttonLoadTrainingData.setText(_translate("Process", "Load"))
        self.DatePairGenTrain.setText(_translate("Process", "DataPairGeneration"))
        self.label_2.setText(_translate("Process", "Testingdata"))
        self.buttonLoadTestingData.setText(_translate("Process", "Load"))
        self.DatePairGenTest.setText(_translate("Process", "DataPairGeneration"))
        ...
        self.radio5FolderPair.setText(_translate("Process", "5-FolderPair"))
        self.radio10FolderPair.setText(_translate("Process", "10-FolderPair"))
        self.radioLeaveOOPair.setText(_translate("Process", "LeaveOOPair"))
