...
class MainWindow(QWidget):
    ...
    def init_title(self):
        self.label_title.setText("Intelligent Diagnosis System for Esophageal Cancer")
    ...
    def init_fun_frame(self):
        ...
        # 创建按钮并分组
        self.button_csv = QPushButton("Radiomics.CSV")
        self.button_load_image = QPushButton("LoadImage")
        ...
        def init_dataload():
            ...
            frame_layout.addWidget(self.button_mask_load, 7)
            ...
            self.button_mask_load.setStyleSheet("QPushButton{"
                                                "background-color:rgb(255, 182, 108);\n"
                                                 "border-width:1px;\n"
                                                 "border-style:solid;\n"
                                                 "border-color:black;\n"
            ...
            self.button_csv.clicked.connect(self.LoadData)
    ...
    def init_res_frame(self):
        ...
        self.button_train.clicked.connect(lambda: self.run(False))
    ...
    def run(self, is_test):
        ...
        self.cross_validation = CrossValidation5Folder()
